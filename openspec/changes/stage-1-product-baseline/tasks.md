...
- [x] 2.11 Capture Oko self-hosting/forking, license, approval-modal control, and EIP-7702 support boundaries; current evidence says Apache-2.0 is permissive, stock modal customization is limited, and EIP-7702/smart-account APIs are unsupported as shipped.
...
- [ ] 2.15 Record OIDC-compatible "Log in with Vana" as an optimistic non-blocking goal and identify the first internal, builder-facing, or partner client that would justify implementing it.
